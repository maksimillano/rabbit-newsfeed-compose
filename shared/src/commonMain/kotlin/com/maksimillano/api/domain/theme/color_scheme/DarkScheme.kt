...
object DarkScheme : ColorScheme {
    ...
    override val secondary = Color(0xff626d7a)
    override val onSecondary = Color(0xff626d7a)
    ...
    override val outline = Color(0xff363738)
    override val outlineVariant = Color(0xffc70c23)
